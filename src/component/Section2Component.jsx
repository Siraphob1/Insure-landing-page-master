...
const Section2Component = () => {
  return (
    <section    className=" bg-[#2d2640] flex flex-col items-center text-white  relative
                            xl:flex-row xl:justify-between  my-[4rem] py-[4rem] px-[1rem] xl:my-[8rem] xl:px-[5rem]">
        ...
        <h1 className="z-[2] font-fontDM text-[2.5rem] leading-[2.5rem] text-center mb-[3rem]
                        xl:text-[3.6rem]  xl:leading-[4rem] xl:text-start xl:w-[50%] xl:mb-0">Find out more about how we work</h1>
